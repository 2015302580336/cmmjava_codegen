...
public class Parser {
    ...
    private static TreeNode parseDeclareStmt() throws ParserException {
        ...
        TreeNode varNode2 = new TreeNode(TreeNode.VAR);
        ...
        if (checkNextTokenType(Token.ID)) {
            ...
            if(checkNextTokenType(Token.COMMA)){
            	consumeNextToken(Token.COMMA);
            	currentToken = iterator.next();
            	hasNext=true;
            	varNode2.setDataType(varNode.getDataType());
            	varNode2.setValue(currentToken.getValue());
            }
            ...
            throw new ParserException("line " + getNextTokenLineNo() + " : next token should be ID or a Array");
        }
        ...
        if(checkNextTokenType(Token.COMMA)){
        	...
        	if (getNextTokenType() == Token.ASSIGN) {
            	...
            	throw new ParserException("line " + getNextTokenLineNo() + " : next token should be =");
            }
